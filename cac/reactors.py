...
class AerosolConstPressureReactor(ct.ExtensibleIdealGasConstPressureMoleReactor):

    def __init__(self, label, *args, **kwargs):
        super(AerosolConstPressureReactor, self).__init__(label, *args, **kwargs)
...
class AerosolReactor(ct.ExtensibleIdealGasMoleReactor):
