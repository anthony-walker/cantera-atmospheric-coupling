...
def KUNKNOWN1183(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN1185(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN1324(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN1332(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN1691(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN1699(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN1892(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN1902(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN1904(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN1915(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2073(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2075(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2080(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2084(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2086(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2090(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2102(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2104(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2108(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2113(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2204(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2206(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2208(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2219(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2221(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2223(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN2257(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2266(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2274(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2279(T, RO2):
    return 2.0e-12*RO2

def KUNKNOWN2284(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2286(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2297(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2413(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2419(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2421(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2426(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN2464(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2466(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2468(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN2500(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2502(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2507(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN2529(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2531(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2536(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2540(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2542(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2547(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2553(T, RO2):
    return 9.2e-14*RO2

def KUNKNOWN2573(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2701(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2703(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2708(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN2777(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2779(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2783(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2790(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN2792(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN2796(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2798(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2800(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2802(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2804(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2806(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2808(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2810(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2812(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2814(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN2845(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2849(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2862(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2869(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2956(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN2961(T, RO2):
    return 8.8e-13*RO2

def KUNKNOWN2973(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN2993(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3006(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN3013(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3021(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN3490(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3492(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3494(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3501(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3503(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3505(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3509(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN3540(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3546(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3548(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3550(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3558(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3560(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3564(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN3608(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3610(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3614(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3622(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3624(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3660(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3662(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3664(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN3681(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3683(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3687(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN3714(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN3716(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN3718(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN3745(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3747(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3749(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3751(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3753(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3755(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3757(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3759(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3761(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3763(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3765(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3767(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3769(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3771(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3773(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3775(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3777(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3779(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3781(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN3962(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN3969(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN4008(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN4010(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN4016(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN4225(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN4227(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN4233(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN4466(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4478(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN4480(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN4486(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN4639(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN4641(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN4643(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4654(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN4753(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN4755(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN4757(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN4813(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4815(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4817(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4819(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4821(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4823(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4825(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4827(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4829(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4831(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4833(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4835(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4837(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4839(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4841(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4843(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4845(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4847(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4849(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4851(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4853(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4855(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN4857(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN5206(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5213(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN5418(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN5420(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN5422(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN5444(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN5446(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN5448(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5453(T, RO2):
    return 8.8e-13*RO2

def KUNKNOWN5465(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN5467(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN5469(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5479(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN5500(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5512(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN5627(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN5629(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN5633(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5642(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN5644(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN5646(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5652(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN5654(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN5656(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5662(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5664(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5666(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN5768(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5774(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN5872(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5882(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN5978(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN5985(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN6145(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN6155(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN6172(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN6181(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN6225(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN6227(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN6229(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN6236(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN6238(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN6240(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN6245(T, RO2):
    return 8.8e-13*RO2

def KUNKNOWN6252(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN6254(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN6256(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN6284(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN6286(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN6288(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN6294(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN6686(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN6688(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN6992(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN6994(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN6999(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN7211(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN7215(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN7228(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN7234(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN7280(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN7282(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN7287(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN7454(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN7456(T, RO2):
    return 7.0e-12*RO2

def KUNKNOWN7463(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN7512(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN7518(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN7632(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN7639(T, RO2):
    return 8.8e-13*RO2

def KUNKNOWN7655(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN7834(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN7846(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN7945(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN7947(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN7952(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN7956(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN7958(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN7960(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN7980(T, RO2):
    return 2.0e-12*RO2

def KUNKNOWN8005(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN8029(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN8031(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN8044(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN8073(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN8075(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN8080(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN8126(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN8135(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN8143(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN8153(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN8155(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN8159(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN8165(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN8923(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN8937(T, RO2):
    return 8.8e-13*RO2

def KUNKNOWN8947(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN8949(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN8954(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN9159(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9170(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9178(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9185(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9193(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9206(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9211(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9225(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9233(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9246(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9251(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9258(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9266(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9281(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9480(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN9482(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN9493(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9574(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN9576(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN9588(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9708(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9720(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9728(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9732(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN9734(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN9743(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN9745(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN9756(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9799(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN9801(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN9816(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9870(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN9872(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN9876(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN9893(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN9931(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN9933(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN9937(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN11378(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN11380(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN11384(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11390(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN11483(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN11485(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN11495(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN11497(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN11501(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN11667(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN11669(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN11677(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN11849(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11862(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN11864(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN11868(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11878(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN11880(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN11884(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11897(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN11904(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11911(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN11919(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11927(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN11945(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11952(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN11978(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11983(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN11990(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN11995(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN12061(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN12063(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN12067(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN12071(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN12073(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN12078(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN12413(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN12415(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN12419(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN12914(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN12916(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN12920(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN12926(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN13046(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN13050(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN13199(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN13206(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN13740(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN13744(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN14197(T, M):
    return 1400300000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN14205(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN14549(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN14551(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN14555(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN14661(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN14663(T, RO2):
    return 1.0e-11*RO2

def KUNKNOWN14667(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN15231(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15243(T, M):
...
def KUNKNOWN15246(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15247(T, M):
...
def KUNKNOWN15251(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15252(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15254(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15257(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15260(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15261(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15262(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15267(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15268(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15271(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15272(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15273(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15275(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15277(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15278(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15280(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)

def KUNKNOWN15281(T, M):
    return 2.09927035332076e-19*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(1658.68274830282*M/T**7.975))**2 + 1))*M/(3.41740825082107e-11*M*T**1.105 + 6.14287260767393e-9*T**6.87)
...
def KUNKNOWN16586(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN16587(T, M):
    return 1400300000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN16750(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN16751(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)
...
def KUNKNOWN16774(T, M):
    return 2090000000000.0*10**(math.log10(0.3)/(1.77777777777778*(0.9525*math.log10(0.3) - math.log10(5.78947368421053e-23*M*math.exp(-24200/T)))**2 + 1))*M*math.exp(-10100/T)/(1.1e-5*M*math.exp(4000/T) + 1.9e+17)

def KUNKNOWN16776(T, M):
