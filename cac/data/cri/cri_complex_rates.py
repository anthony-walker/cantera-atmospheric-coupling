...
def KUNKNOWN94(T):
    return 3.24e-18*T@(2)*math.exp(414/T)
...
def KUNKNOWN224(T):
    return 8.91e-18*T@(2)*math.exp(837/T)

def KUNKNOWN237(T):
    return 6.82e-18*T@(2)*math.exp(800/T)*0.76

def KUNKNOWN238(T):
    return 6.82e-18*T@(2)*math.exp(800/T)*0.24

def KUNKNOWN239(T):
    return 6.92e-19*T@(2)*math.exp(986/T)

def KUNKNOWN285(T):
    return 2.03e-16*(T/300)@(4.57)*math.exp(693/T)

def KUNKNOWN420(T):
    return 1.16e-17*T@(2)*math.exp(225/T)
...
def KUNKNOWN471(T):
    return 8.54e-19*T@(2)*math.exp(455/T)

def KUNKNOWN488(T):
    return 6.54e-18*T@(2)*math.exp(483/T)*0.51

def KUNKNOWN489(T):
    return 6.54e-18*T@(2)*math.exp(483/T)*0.49

def KUNKNOWN496(T):
    return 2.48e-18*T@(2)*math.exp(926/T)

def KUNKNOWN498(T):
    return 3.13e-17*T@(2)*math.exp(416/T)

def KUNKNOWN502(T):
    return 2.44e-17*T@(2)*math.exp(183/T)

def KUNKNOWN503(T):
    return 1.53e-17*T@(2)*math.exp(414/T)
...
def KUNKNOWN822(T):
    return 1.39e-18*T@(2)*math.exp(991/T)*0.4

def KUNKNOWN823(T):
    return 1.39e-18*T@(2)*math.exp(991/T)*0.6

def KUNKNOWN867(T, N2, O2):
    return 5.6e-34*N2*(T/300)@(-2.6)*O2

def KUNKNOWN868(T, O2):
    return 6.0e-34*O2*(T/300)@(-2.6)*O2

def KUNKNOWN1237(T, ISOM):
    return 2.4e-14*math.exp(460/T)6ISOM*0.5

def KUNKNOWN1240(T, ISOM):
    return 2.4e-14*math.exp(460/T)6ISOM*0.5
